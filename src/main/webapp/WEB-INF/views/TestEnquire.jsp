...
<title>EpicTasteExchange - Enquire</title>
		...
		<div
			...
			<nav id="navmenu" class="navmenu">
				<ul>
					...
					<li><a href="/test/enquire" class="active">Enquire Now</a></li>
...
<!-- 		<div class="parallax-mirror" style="z-index: -100; position: fixed; overflow: hidden; transform: translate3d(0px, 0px, 0px); visibility: visible; top: 263.9px; left: 0px; height: 296px; width: 1519px;"> -->
<%-- 			<img class="parallax-slider" src="${pageContext.request.contextPath}/assets/img/Parallax 4.jpg" style="transform: translate3d(0px, 0px, 0px); position: absolute; top: -796.12px; left: 0px; height: 1545px; width: 1519px; max-width: none;"> --%>
<!-- 		</div> -->
		
<!-- 		<div class="parallax-mirror" style="z-index: -100; position: fixed; overflow: hidden; transform: translate3d(0px, 0px, 0px); visibility: hidden; top: 328.7px; left: 0px; height: 296px; width: 1519px;"> -->
<%-- 			<img class="parallax-slider" src="${pageContext.request.contextPath}/assets/img/Parallax 3.jpg" style="transform: translate3d(0px, 0px, 0px); position: absolute; top: -562.96px; left: 0px; height: 976px; width: 1519px; max-width: none;"> --%>
<!-- 		</div> -->
		
<!-- 		<div class="parallax-mirror" style="z-index: -100; position: fixed; overflow: hidden; transform: translate3d(0px, 0px, 0px); visibility: visible; top: -95.9px; left: 0px; height: 296px; width: 1519px;"> -->
<%-- 			<img class="parallax-slider" src="${pageContext.request.contextPath}/assets/img/Parallax 2.jpg" style="transform: translate3d(0px, 0px, 0px); position: absolute; top: -495.28px; left: 0px; height: 1519px; width: 1519px; max-width: none;"> --%>
<!-- 		</div> -->
		
<!-- 		<div class="parallax-mirror" style="z-index: -100; position: fixed; overflow: hidden; transform: translate3d(0px, 0px, 0px); visibility: hidden; top: -292px; left: 0px; height: 296px; width: 1519px;"> -->
<%-- 			<img class="parallax-slider" src="${pageContext.request.contextPath}/assets/img/Parallax 1.jpg" style="transform: translate3d(0px, 0px, 0px); position: absolute; top: 233.6px; left: 0px; height: 976px; width: 1519px; max-width: none;"> --%>
<!-- 		</div> -->
		...
		<section class="career-section section">
			...
			<form id="enquireForm" class="career-form" data-aos="fade-up"
				data-aos-delay="200" method="POST" action="/submitEnquiry"
		...
		<div class="parallax-container" data-parallax="scroll" data-position="top" data-bleed="10" data-image-src="${pageContext.request.contextPath}/assets/img/Parallax 1.jpg" data-natural-width="1400" data-natural-height="900" style="height: 276px;">
		</div>
		...
		<section class="career-section section">
			...
			<form id="consumerForm" class="career-form" data-aos="fade-up"
				data-aos-delay="200" method="POST" action="/submitEnquiry"
				enctype="multipart/form-data">
		...
		<div class="parallax-container" data-parallax="scroll" data-bleed="10" data-speed="0.2" data-image-src="${pageContext.request.contextPath}/assets/img/Parallax 2.jpg" data-natural-width="1400" data-natural-height="1400" style="height: 276px;">
		</div>
		...
		<section class="career-section section">
			...
			<form id="supplierForm" class="career-form" data-aos="fade-up"
				data-aos-delay="200" method="POST" action="/submitEnquiry"
				enctype="multipart/form-data">
		...
		<div class="parallax-container" data-parallax="scroll" data-bleed="10" data-image-src="${pageContext.request.contextPath}/assets/img/Parallax 3.jpg" data-natural-width="1400" data-natural-height="900" style="height: 276px;">
		</div>
		
		<div class="parallax-container" data-parallax="scroll" data-bleed="10" data-image-src="${pageContext.request.contextPath}/assets/img/Parallax 4.jpg" data-natural-width="750" data-natural-height="763" style="height: 276px;">
		</div>
