...
<title>404 Page Not Found - EpicTasteExchange</title>
	...
	<main class="main">
		...
		<section id="error" class="hero section dark-background">
			...
			<div class="row justify-content-center text-center mb-5" data-aos="zoom-out">
				<h2>Page Not Found<br><br>The page you are looking for might have been removed or is temporarily unavailable.<</h2>
			</div>
